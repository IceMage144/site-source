...
class City {
    constructor(x, y) {
        this.x = x;
        this.y = y;
        this.sprite = new Sprite("/images/missile-command/City.png", x, y);
...
class Base {
    constructor(x, y) {
        this.x = x;
        this.y = y;
        this.dome = new Sprite("/images/missile-command/Base.png", x, y);
    }
    start() {
        let x = this.x;
        let y = this.y;
        ...
        this.state = true;
        for (let i = 0; i < 3; i++)
            this.ammo.push(new Sprite("/images/missile-command/Missile.png", x + 8*i + 20, y - 4));
        for (let i = 0; i < 4; i++)
            this.ammo.push(new Sprite("/images/missile-command/Missile.png", x + 8*i + 16, y + 4));
        for (let i = 0; i < 5; i++)
            this.ammo.push(new Sprite("/images/missile-command/Missile.png", x + 8*i + 12, y + 12));
    }
    update(dt) {}
    draw(ctx) {
        this.dome.draw(ctx);
...
function main() {
    ...
    Game.bind(37, function() { if (Game.ingame && !Game.pause) Cursor.next[0] = -1; }, KEY_PRESS);
    Game.bind(38, function() { if (Game.ingame && !Game.pause) Cursor.next[1] = -1; }, KEY_PRESS);
    Game.bind(39, function() { if (Game.ingame && !Game.pause) Cursor.next[0] = 1; }, KEY_PRESS);
    Game.bind(40, function() { if (Game.ingame && !Game.pause) Cursor.next[1] = 1; }, KEY_PRESS);
    Game.bind(37, function() { if (Game.ingame && !Game.pause) Cursor.next[0] = 0; }, KEY_UP);
    Game.bind(38, function() { if (Game.ingame && !Game.pause) Cursor.next[1] = 0; }, KEY_UP);
    Game.bind(39, function() { if (Game.ingame && !Game.pause) Cursor.next[0] = 0; }, KEY_UP);
    Game.bind(40, function() { if (Game.ingame && !Game.pause) Cursor.next[1] = 0; }, KEY_UP);
