...
var Play = new Button("/images/buttons/Play.png", (rwidth-160)/2, 230, startGame);
...
function main() {
    ...
    Game.bind(37, function() { if (Game.ingame && !Game.paused) Cursor.nextDir = 2; }, KEY_PRESS);
    Game.bind(39, function() { if (Game.ingame && !Game.paused) Cursor.nextDir = 0; }, KEY_PRESS);
    Game.bind(40, function() { if (Game.ingame && !Game.paused) Cursor.nextDir = 3; }, KEY_PRESS);
    //Game.bind(83, function() { Game.stop(); }, KEY_DOWN);
    Game.bind(80, function() { if (Game.ingame) pause(); }, KEY_DOWN);
    Game.bind(90, function() { if (Game.ingame && !Game.paused) Cursor.rotateL(); }, KEY_DOWN);
    Game.bind(88, function() { if (Game.ingame && !Game.paused) Cursor.rotateR(); }, KEY_DOWN);
    showMenu();
}
